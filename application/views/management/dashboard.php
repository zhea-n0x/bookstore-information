      ...
      <div class="content">
        <div class="row">
          <div class="col-lg-3">
            <div class="card card-chart">
              <div class="card-header">
                <h5 class="card-category text-danger">Info</h5>
                <h4 class="card-title">Jumlah Buku Saat Ini</h4>
                <h2><?= $jmlbuku;?> Buku</h2>
              </div>
              <div class="card-body">
          ...
          <div class="col-lg-3 col-md-6">
            <div class="card card-chart">
              <div class="card-header">
                <h5 class="card-category text-dark">Info</h5>
                <h4 class="card-title">Lokasi Buku Tersimpan</h4>
                <h2><?= $jmllokasi;?> Lokasi</h2>
              </div>
              <div class="card-body">
                <div class="chart-area">
          ...
          <div class="col-lg-3 col-md-6">
            <div class="card card-chart">
              <div class="card-header">
                ...
                <h4 class="card-title">Jumlah Terdaftar</h4>
                <h2><?= $jmlauthor; ?> Penulis</h2>
              </div>
              <div class="card-body">
                <div class="chart-area">
