          ...
          <div class="col-md-12">
            ...
            <table class="table" id="table_id">
                ...
                <tr align="center">
                    ...
                    <td>
                      <a href="<?= base_url('admin/edit_book/');?><?= $row['book_id']?>" class="btn btn-success"><i class="now-ui-icons ui-1_settings-gear-63"></i> Edit</a>
                      <a href="<?= base_url('control_data/remove_book/');?><?= $row['book_id'];?>" class="btn btn-danger" onclick="return confirm('Apakah Yakin Ingin Menghapus Data Ini ?')"><i class="now-ui-icons ui-1_simple-remove"></i> Hapus</a>
                    </td>
                </tr>
                <?php $i++; }?>
                </tbody>
