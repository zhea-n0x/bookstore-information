          ...
          <div class="col-md-6">
            <div class="card">
              <div class="card-header">
                ...
                <small class="text-small" style="margin-top: -100px;">masukkan update <i>penulis</i> sesuai format pada <b>kolom</b> yang tersedia</small>
              </div>
              <div class="card-body">
                <form action="<?= base_url('control_data/updateauthor');?>" method="POST">
                    <?php
                    $id = rand(0000,9999);
                    ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="id" value="<?= $author['author_id'];?>">
                        <small class="form-text text-muted">nomor identifikasi tergenerate secara otomatis</small>
                    </div>
                    <div class="form-group">
                        <label for="lokasi">Nama Penulis</label>
                        <input type="text" class="form-control" name="nama" value="<?= $author['author_name'];?>" placeholder="e.g John Doe">
                    </div>
                    <div class="form-group">
                        <label for="email">Email Penulis</label>
                        <input type="text" class="form-control" name="email" value="<?= $author['email'];?>" placeholder="e.g johnadam@doe.com">
                    </div>
                    <div class="form-group">
                        <label for="id">Tahun Aktif</label>
                        <input type="text" class="form-control" name="aktif" value="<?= $author['years_active'];?>" placeholder="e.g 2017-2020 or 2000-Presents">
