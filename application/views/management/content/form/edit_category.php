          ...
          <div class="col-md-6">
            <div class="card">
              <div class="card-header">
                ...
                <small class="text-small" style="margin-top: -100px;">masukkan data <i>kategori</i> sesuai format pada <b>kolom</b> yang tersedia</small>
              </div>
              <div class="card-body">
                <form action="<?= base_url('control_data/updatecategory');?>" method="POST">
                    <?php
                    $id = rand(00,99);
                    ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="ident" value="<?= $category['category_id'];?>" name="id">
                        <small class="form-text text-muted">nomor identifikasi tergenerate secara otomatis</small>
                    </div>
                    <div class="form-group">
                        <label for="lokasi">Nama Kategori</label>
                        <input type="text" class="form-control" id="lokasi"  value="<?= $category['category_name'];?>" name="nama">
                        <small class="form-text text-muted">format nama kategori diawal huruf kapital</small>
                    </div>
                    <button type="submit" class="btn btn-primary">Submit</button>
                    <a href="<?= base_url('admin/category_management');?>" class="btn btn-secondary">Cancel</a>
                </form>
              </div>
            </div>
          </div>
