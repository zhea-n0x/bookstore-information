          ...
          <div class="col-md-6">
            <div class="card">
              <div class="card-header">
                ...
                <small class="text-small" style="margin-top: -100px;">masukkan data <i>lokasi</i> sesuai format pada <b>kolom</b> yang tersedia</small>
              </div>
              <div class="card-body">
                <form action="<?= base_url('control_data/insertlocation');?>" method="POST">
                    <?php
                    $id = rand(000,999);
                    ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="ident" value="<?= $id;?>" name="ident">
                        <small class="form-text text-muted">nomor identifikasi tergenerate secara otomatis</small>
                    </div>
                    <div class="form-group">
                        <label for="lokasi">Lokasi</label>
                        <input type="text" class="form-control" id="lokasi" placeholder="e.g Rack no. 2" name="lokasi">
