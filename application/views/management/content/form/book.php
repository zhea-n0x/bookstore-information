          ...
          <div class="col-md-6">
            <div class="card">
              <div class="card-header">
                ...
                <small class="text-small" style="margin-top: -100px;">silahkan tambah data <i>buku</i> yang valid pada <b>kolom</b> yang tersedia</small>
              </div>
              <div class="card-body">
                <form action="<?= base_url('control_data/insertbook');?>" method="POST">
                    <?php
                    $id = rand(00000,99999);
                    ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="ident" value="<?= $id;?>" name="id">
                        <small class="form-text text-muted">nomor identifikasi tergenerate secara otomatis</small>
                    </div>
                    <div class="form-group">
                        <label for="lokasi">Judul Buku</label>
                        <input type="text" class="form-control" id="lokasi" placeholder="e.g Pencari Uang di Jalan" name="judul">
                        <small class="form-text text-muted">format judul buku sesuai format pada kolom diatas</small>
                    </div>
                    <div class="form-group">
                      <label for="harga">Harga Buku</label>
                      <input type="text" class="form-control" placeholder="25000" name="harga">
                      <small class="form-text text-muted">format harga tanpa karakter huruf, titik, dan lainnya</small>
                    </div>
                    <div class="form-group">
