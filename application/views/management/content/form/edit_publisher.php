          ...
          <div class="col-md-6">
            <div class="card">
              <div class="card-header">
                ...
                <small class="text-small" style="margin-top: -100px;">masukkan update <i>penerbit</i> sesuai format pada <b>kolom</b> yang tersedia</small>
              </div>
              <div class="card-body">
                <form action="<?= base_url('control_data/updatepublisher');?>" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="id" value="<?= $publisher['publisher_id'];?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="penerbit" value="<?= $publisher['publisher_name'];?>" placeholder="e.g Gramedia Jaya">
                    </div>
                    <div class="form-group">
                        <label for="email">Email Penerbit</label>
                        <input type="text" class="form-control" name="email" value="<?= $publisher['email'];?>" placeholder="e.g act@gerak.org">
                    </div>
                    <div class="form-group">
                        <label for="id">Alamat Pusat</label>
                        <input type="text" class="form-control" name="alamat" value="<?= $publisher['address'];?>" placeholder="Jl. Baru no. 56, Jakarta Timur">
