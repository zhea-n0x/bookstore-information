      ...
      <div class="sidebar-wrapper" id="sidebar-wrapper">
        <ul class="nav">
          ...
          <li>
            ...
            <li>
            <a href="#location" data-toggle="collapse" class="text-dark">
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title"> Lokasi Buku</h4>
                <small class="text-small" style="margin-top: -100px;">silahkan cari <i>lokasi</i> yang kamu inginkan pada <b>kolom</b> yang tersedia</small>
              </div>
              <div class="card-body">
              <?php if($this->session->flashdata('pesan')) :?>  
                  <div class="alert alert-success alert-dismissible fade show card-title" rules="alert">
              ...
              <table class="table" id="table_id">
                ...
                <tr align="center">
                    ...
                    <th class="text-danger">Lokasi</th>
                    <th class="text-danger">Pilihan</th>
                </tr>
                </thead>
                <tbody> 
                <?php
                $i=1;
                foreach($locdetail as $row) { ?>
                <tr align="center">
                    <td><?php echo $row['location_id']; ?></td>
                    <td><?php echo $row['location']; ?></td>
                    <td>
                      <a href="<?= base_url('admin/edit_location/');?><?= $row['location_id']?>" class="btn btn-success"><i class="now-ui-icons ui-1_settings-gear-63"></i> Edit</a>
                      <a href="<?= base_url('control_data/remove_location/');?><?= $row['location_id'];?>" class="btn btn-danger" onclick="return confirm('Apakah Yakin Ingin Menghapus Data Ini ?')"><i class="now-ui-icons ui-1_simple-remove"></i> Hapus</a>
                    </td>
                </tr>
                <?php $i++; }?>
                </tbody>
