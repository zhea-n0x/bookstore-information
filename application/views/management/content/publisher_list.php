      ...
      <div class="sidebar-wrapper" id="sidebar-wrapper">
        <ul class="nav">
          ...
          <li>
            ...
            <li>
            <a href="#publisher" data-toggle="collapse" class="text-dark">
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                ...
                <small class="text-small" style="margin-top: -100px;">silahkan cari <i>penerbit</i> yang kamu inginkan pada <b>kolom</b> yang tersedia</small>
              </div>
              <div class="card-body">
              ...
              <table class="table" id="table_id">
                ...
                <tr align="center">
                    ...
                    <th class="text-danger">Alamat Perusahaan</th>
                ...
                <tr align="center">
                    ...
                    <td>
                      <a href="<?= base_url('admin/edit_publisher/');?><?= $row['publisher_id']?>" class="btn btn-success"><i class="now-ui-icons ui-1_settings-gear-63"></i> Edit</a>
                      <a href="<?= base_url('control_data/remove_publisher/');?><?= $row['publisher_id'];?>" class="btn btn-danger" onclick="return confirm('Apakah Yakin Ingin Menghapus Data Ini ?')"><i class="now-ui-icons ui-1_simple-remove"></i> Hapus</a>
                    </td>
                </tr>
                <?php $i++; }?>
                </tbody>
