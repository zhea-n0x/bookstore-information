  ...
  <div class="sidebar" data-color="blue">
      ...
      <div class="sidebar-wrapper" id="sidebar-wrapper">
        ...
        <div class="active-pro" style="margin-top: auto;">
          <li>
            <a href="<?= base_url('admin/user_management')?>" class="text-dark">
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                ...
                <small class="text-small" style="margin-top: -100px;">silahkan cari <i>admin</i> yang kamu inginkan pada <b>kolom</b> yang tersedia</small>
                <br>
              <a href="<?= base_url('admin/add_admin')?>" class="btn btn-primary">+ Tambah Admin</a>
              </div>
              <div class="card-body">
              ...
              <table class="table" id="table_id">
                ...
                <tr align="center">
                    ...
                    <th class="text-danger">Nama Admin</th>
                ...
                <tr align="center">
                    ...
                    <td><img src="<?= base_url('assets/img/admin_photo/');?><?= $row['img_admin']; ?>" alt="" height="150" width="150" style="border-radius: 20px;"></img></td>
                    <td>
                      <a href="<?= base_url('control_data/remove_admin/');?><?= $row['admin_id'];?>" class="btn btn-danger" onclick="return confirm('Apakah Yakin Ingin Menghapus Data Ini ?')"><i class="now-ui-icons ui-1_simple-remove"></i> Hapus</a>
                    </td>
                </tr>
                <?php $i++; }?>
                </tbody>
