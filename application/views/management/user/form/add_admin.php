          ...
          <div class="col-md-6">
            <div class="card">
              <div class="card-header">
                ...
                <small class="text-small" style="margin-top: -100px;">masukkan data <i>admin</i> sesuai format pada <b>kolom</b> yang tersedia</small>
              </div>
              <div class="card-body">
                <form action="<?= base_url('control_data/insertadmin');?>" method="post" enctype="multipart/form-data">
                    <?php
                    $id = rand(000,999);
                    ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="nama" placeholder="e.g John Doe">
                    </div>
                    <div class="form-group">
                        <label for="email">Email Admin</label>
                        <input type="text" class="form-control" name="email" placeholder="e.g johnadam@doe.com">
                    </div>
                    <div class="form-group">
