          ...
          <div class="col-md-6">
            <div class="card">
              <div class="card-header">
                ...
                <small class="text-small" style="margin-top: -100px;">masukkan pembaharuan <i>profil</i> sesuai format pada <b>kolom</b> yang tersedia</small>
              </div>
              <div class="card-body">
                <form action="<?= base_url('control_data/updateadmin');?>" enctype="multipart/form-data" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="id" value="<?= $admin['admin_id'];?>">
                        <small class="form-text text-muted">nomor identifikasi tergenerate secara otomatis</small>
                    </div>
                    <div class="form-group">
                        <label for="lokasi">Nama Lengkap</label>
                        <input type="text" class="form-control" name="penerbit" value="<?= $admin['admin_name'];?>" placeholder="e.g Gramedia Jaya">
                    </div>
                    <div class="form-group">
                        <label for="email">Email Anda</label>
                        <input type="text" class="form-control" name="email" value="<?= $admin['email'];?>" placeholder="e.g act@gerak.org">
                    </div>
                    <div class="form-group">
                        <label for="id">Password</label>
                        <input type="password" class="form-control" name="alamat" value="<?= $admin['password'];?>" placeholder="Jl. Baru no. 56, Jakarta Timur">
                        <small class="form-text text-muted">sesuaikan inputan dengan contoh pada kolom</small>
                    </div>
                    <div class="form-group">
                        <label for="">Upload Foto</label>
                        <div class="custom-file form-control">
                            <input  name="image" type="file" class="custom-file-input form-control" id="inputGroupFile02">
                            <label class="custom-file-label" for="inputGroupFile02"><?= $admin['img_admin'];?></label>
                        </div>
                    </div>
          ...
          <div class="col-md-4">
            <div class="card card-user">
              ...
              <div class="card-body">
                <div class="author">
                  <a href="#">
                    <img class="avatar border-gray" src="<?= base_url('assets/img/admin_photo/')?><?= $admin['img_admin'];?>" alt="...">
                    <h5 class="title"><?= $admin['admin_name'];?></h5>
                  </a>
                  <p class="description">
                    <?= $admin['email'];?>
                  </p>
